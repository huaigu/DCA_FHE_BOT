  ...
  const handleSubmit = useCallback(
    async (e: React.FormEvent) => {
      ...
      try {
        ...
        const result = await submitIntent(intentParams, SEPOLIA_CONTRACTS.INTENT_COLLECTOR, address);
    ...
    return (
      <Card className="w-full max-w-4xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>Connect your wallet to create encrypted DCA intents</CardDescription>
        </CardHeader>
        <CardContent className="text-center">
          <p className="text-muted-foreground">Please connect your wallet to access the DCA form</p>
        </CardContent>
      </Card>
    );
  }
        ...
        <div className="px-6 pb-4">
          <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-lg p-4 border">
            <div className="flex items-center justify-between mb-3">
              ...
              >
                {isUSDCLoading || isFundPoolLoading ? <Loader2 className="w-4 h-4 animate-spin" /> : "Refresh"}
              </Button>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex items-center justify-between p-3 bg-white rounded-lg border">
                ...
                <div className="text-right">
                  <p className="text-sm font-mono font-medium">
                    {isUSDCLoading ? <Loader2 className="w-4 h-4 animate-spin inline" /> : formatAmount(usdcBalance)}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between p-3 bg-white rounded-lg border">
                ...
                <div className="text-right">
                  <p className="text-sm font-mono font-medium">
                    {isFundPoolLoading ? <Loader2 className="w-4 h-4 animate-spin inline" /> : availableBalance}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-3 flex gap-2">
              <Button variant="outline" size="sm" onClick={() => setShowDepositModal(true)} className="flex-1">
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  step="0.01"
                />
                <p className="text-xs text-muted-foreground">Total amount to invest in USDC</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  step="1"
                />
                <p className="text-xs text-muted-foreground">How many purchases to make</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  ...
                  {formData.investmentAmount && formData.tradesCount
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  step="1"
                />
                <p className="text-xs text-muted-foreground">Hours between each trade</p>
              </div>
            </div>
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      step="0.01"
                    />
                    <p className="text-xs text-muted-foreground">Only buy when ETH price is above this</p>
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      step="0.01"
                    />
                    <p className="text-xs text-muted-foreground">Only buy when ETH price is below this</p>
                  </div>
                </div>
                ...
                <div className="mt-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                  <p className="text-sm text-blue-800">
                    ...
                    Your price range will be encrypted and hidden from all observers. Only qualifying intents will be
                    executed in each batch.
                  </p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="text-center text-xs text-muted-foreground space-y-1">
              <p>Your intent will be encrypted and added to the next batch.</p>
              <p>
                Execution requires {DCA_CONFIG.MIN_BATCH_SIZE}-{DCA_CONFIG.MAX_BATCH_SIZE} users and matching price
                conditions.
              </p>
            </div>
          </form>
