...
export const SEPOLIA_CONTRACTS = {
  ...
  FUND_POOL: process.env.NEXT_PUBLIC_FUND_POOL_ADDRESS || '0x6473d5BC0D335f2e1E2fe0799878438721b0B8Ce',
  INTENT_COLLECTOR: process.env.NEXT_PUBLIC_INTENT_COLLECTOR_ADDRESS || '0x0F173BF00b2C309189329416965236cB2fE6eA64',
  BATCH_PROCESSOR: process.env.NEXT_PUBLIC_BATCH_PROCESSOR_ADDRESS || '0xacA793F2EA121731bf6418b9A0e0A807d669261c',
