...
export const SEPOLIA_CONTRACTS = {
  ...
  FUND_POOL: process.env.NEXT_PUBLIC_FUND_POOL_ADDRESS || '0xc0580b49B0e095cCB47FB6A9a79222106Aa93397',
  INTENT_COLLECTOR: process.env.NEXT_PUBLIC_INTENT_COLLECTOR_ADDRESS || '0x2f1DD937bAb10246139E626855071227e70738C4',
  BATCH_PROCESSOR: process.env.NEXT_PUBLIC_BATCH_PROCESSOR_ADDRESS || '0xeCE36898834336e156Bb21F0472fa1c931266c86',
